...
dados_indesejados = saidas + variaveis_faltantes

# CORREÇÃO: Selecionar apenas as colunas das saídas e depois filtrar as linhas
corr_saidas = corr[saidas]  # pega apenas colunas das saídas
corr_saidas = corr_saidas.drop(dados_indesejados, errors='ignore')  # remove linhas das próprias saídas e variáveis faltantes
